  ...
  return (
    <section id="models" className="border-b border-border">
      <div className="mx-auto max-w-6xl px-6 py-24 md:py-32">
        ...
        <article className="group relative grid overflow-hidden rounded-2xl border border-foreground/20 bg-card transition-transform duration-300 hover:-translate-y-1 md:grid-cols-2">
          ...
          <div className="flex flex-col justify-between gap-10 p-8 md:p-12 lg:p-16">
            <div>
              <p className="max-w-lg text-lg leading-relaxed text-muted-foreground md:text-xl">
                Bayon is the first native, from-scratch decoder-only generative
                Khmer language model. Unlike many existing models that are simply
                fine-tuned versions of Western or multilingual architectures,
                this model was built and pretrained entirely from scratch by
                Cambodians, for Cambodia.
              </p>
            </div>
